...
# (( is_sourced = $? ))
# # Invoke script with zsh command if being sourced
# if (( $is_sourced ))
# then
#     builtin print -Pu2 "%F{249}Script should not be sourced—running script directly.%f"
#     zsh ${0}
# fi
...
[[ -x "$(command -v xelatex)" ]] || die 12 "xelatex command is unavailable" # MacTeX/TeX Live
...
# Compile
xelatex -output-directory ../output book.tex && cp ../output/book.pdf ../build/book.pdf
